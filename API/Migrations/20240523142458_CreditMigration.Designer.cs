...
namespace API.Migrations
{
    ...
    [Migration("20240523142458_CreditMigration")]
            ...
            modelBuilder.Entity("API.Models.Carte", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Bin = 123456,
                            ClientId = 1,
                            DateDelivrance = new DateTime(2023, 5, 24, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7710),
                            DateExpiration = new DateTime(2027, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7712),
                            Mobile = 123456789,
                            PlafondGAB = 500,
                            PlafondTPE = 1000,
                            ResteGAB = 500,
                        ...
                        new
                        {
                            ...
                            Bin = 987654,
                            ClientId = 2,
                            DateDelivrance = new DateTime(2023, 4, 19, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7720),
                            DateExpiration = new DateTime(2028, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7721),
                            Mobile = 987654321,
                            PlafondGAB = 1000,
                            PlafondTPE = 2000,
                            ResteGAB = 800,
                        ...
                        new
                        {
                            ...
                            Bin = 654321,
                            ClientId = 1,
                            DateDelivrance = new DateTime(2023, 7, 28, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7725),
                            DateExpiration = new DateTime(2026, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7726),
                            Mobile = 111222333,
                            PlafondGAB = 800,
                            PlafondTPE = 1500,
                            ResteGAB = 600,
                        ...
                        new
                        {
                            ...
                            Bin = 987123,
                            ClientId = 3,
                            DateDelivrance = new DateTime(2023, 11, 5, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7729),
                            DateExpiration = new DateTime(2027, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7730),
                            Mobile = 444555666,
                            PlafondGAB = 1200,
                            PlafondTPE = 2500,
                            ResteGAB = 1000,
            ...
            modelBuilder.Entity("API.Models.Compte", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            DateOuvertureCompte = new DateTime(2024, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7550),
                            NumeroCompte = 1001,
                            SoldeCompte = 1000m,
                            StatutCompte = "Active",
                            TypeCompte = "Checking"
                        ...
                        new
                        {
                            Id = 2,
                            ClientId = 2,
                            DateOuvertureCompte = new DateTime(2024, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7554),
                            NumeroCompte = 1002,
                            SoldeCompte = 2000m,
                            StatutCompte = "Active",
                            TypeCompte = "Savings"
                        ...
                        new
                        {
                            Id = 3,
                            ClientId = 3,
                            DateOuvertureCompte = new DateTime(2024, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7557),
                            NumeroCompte = 1003,
                            SoldeCompte = 1500m,
                            StatutCompte = "Active",
                        ...
                        new
                        {
                            Id = 4,
                            ClientId = 1,
                            DateOuvertureCompte = new DateTime(2024, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7560),
                            NumeroCompte = 1004,
                            SoldeCompte = 3000m,
                            StatutCompte = "Active",
                            TypeCompte = "Credit"
                        ...
                        new
                        {
                            Id = 5,
                            ClientId = 2,
                            DateOuvertureCompte = new DateTime(2024, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7564),
                            NumeroCompte = 1005,
                            SoldeCompte = 5000m,
                            StatutCompte = "Active",
                            TypeCompte = "Loan"
            ...
            modelBuilder.Entity("API.Models.Credit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JourPaiement = 1,
                            LastVerificationDate = new DateTime(2024, 4, 27, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7019),
                            MontantCredit = 500m,
                            RestCredit = 500m
                        },
                        new
            ...
            modelBuilder.Entity("API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AvatarUrl = "",
                            DateCreated = new DateTime(2024, 5, 23, 15, 24, 57, 836, DateTimeKind.Local).AddTicks(7116),
                            Email = "admin@contact.com",
                            Etat = true,
                            FirstName = "Admin",
                            LastName = "Admin",
                            Login = "Admin",
                            PasswordHash = new byte[] { 113, 50, 116, 5, 115, 212, 43, 132, 18, 71, 244, 156, 48, 174, 214, 238, 180, 96, 0, 99, 244, 116, 143, 106, 15, 95, 225, 16, 16, 16, 202, 215, 71, 151, 182, 70, 167, 24, 78, 166, 202, 40, 125, 32, 224, 239, 79, 231, 182, 161, 24, 180, 121, 254, 64, 192, 191, 111, 195, 23, 251, 242, 71, 116 },
